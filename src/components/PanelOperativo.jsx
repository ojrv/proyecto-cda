...
function PanelOperativo({ bloque }) {
  const {
    titulo_bloque,
    icono,
    color_base,
  ...
  return (
    <div className={`panel-operativo ${estilo_card}`} style={{ backgroundColor: color_base, padding: '1rem', borderRadius: '8px', marginBottom: '1rem' }}>
